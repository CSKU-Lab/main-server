...
const file_grader_v1_service_proto_rawDesc = "" +
	"\n" +
	"\x17grader/v1/service.proto\x12\tgrader.v1\x1a\x18grader/v1/messages.proto2\xb4\x02\n" +
	"\rGraderService\x12>\n" +
	...
	"\x0eGetGradeResult\x12 .grader.v1.GetGradeResultRequest\x1a\x1e.grader.v1.GradeResultResponse\"\x00B\x94\x01\n" +
...
var file_grader_v1_service_proto_goTypes = []any{
	...
	(*GradedResponse)(nil),        // 5: grader.v1.GradedResponse
	(*GradeResultResponse)(nil),   // 6: grader.v1.GradeResultResponse
}
var file_grader_v1_service_proto_depIdxs = []int32{
	...
	4, // 5: grader.v1.GraderService.GetRunResult:output_type -> grader.v1.RunResultResponse
	5, // 6: grader.v1.GraderService.Grade:output_type -> grader.v1.GradedResponse
	6, // 7: grader.v1.GraderService.GetGradeResult:output_type -> grader.v1.GradeResultResponse
