...
func NewSubmissionServiceArgs(
	...
	return &services.SubmissionServiceArgs{
		...
		DocumentMaterialRepository: docMatRepo,
		InputSubmissionRepository:  inputSubmissionRepo,
		PubSub:                     pubSub,
...
var ServiceSet = wire.NewSet(
	...
	services.NewInputSubmissionService,
	services.NewAuthLogService,
	services.NewUserActivityService,
