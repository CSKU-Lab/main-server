...
type User interface {
	...
	GetManyByFindBy(ctx context.Context, data []string, findBy string, role string) ([]UserData, error)
	...
	Upsert(ctx context.Context, user CreateMultiTypeUser) (string, error)
